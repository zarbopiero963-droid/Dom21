...
def run_cert():
    ...
    create_mock_controller() # Reboot
    strict_audit(c.db, 1000.0, 0, 0)
    ...
    c2 = create_mock_controller() # Reboot
    c2.db.resolve_panics() # Bootloader action
    strict_audit(c2.db, 998.0, 1, 0)
